...
from ..utils.constants import ApiEndpoints, USER_AGENT, WBI_KEY_INDEX_TABLE
...
class WbiSigner:
    ...
    def add_wbi_sign(self, params: dict) -> dict:
        ...
        # 按key字典序排序
        params_to_sign = {
            key: params_to_sign[key] for key in sorted(params_to_sign.keys())
        }
